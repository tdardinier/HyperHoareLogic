...
text \<open>In this file, we prove that the two examples from section 3 satisfy resp. violate GNI,
using the proof outlines from appendix A. We also prove the correctness of the two compositionality
proofs presented in section 5.\<close>
